...
Alternatively, you can manually copy the key file from the hosts to the nodes and then append the contents to the end of the node’s `~/.ssh/authorized_keys` file.
